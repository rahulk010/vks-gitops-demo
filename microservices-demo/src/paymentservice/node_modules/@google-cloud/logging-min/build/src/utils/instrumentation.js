...
function validateAndUpdateInstrumentation(infoList) {
    ...
    for (const info of infoList) {
        if (isValidInfo(info)) {
            ...
            if (++count === exports.MAX_INSTRUMENTATION_COUNT)
                break;
        }
    }
